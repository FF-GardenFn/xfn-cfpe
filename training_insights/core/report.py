...
def get_system_info():
    ...
    info['core_base_dir'] = os.environ.get('NANOCHAT_BASE_DIR', 'out')
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print(f"Warning: {header_file} does not exist. Did you forget to run `core reset`?")
...
# -----------------------------------------------------------------------------
# core-specific convenience functions
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset core training reports.")

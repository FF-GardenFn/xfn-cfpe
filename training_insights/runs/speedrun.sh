...
# Default intermediate artifacts directory is in ~/.cache/core
export OMP_NUM_THREADS=1
export NANOCHAT_BASE_DIR="$HOME/.cache/core"
...
# download 2.3MB of synthetic identity conversations to impart a personality to core
...
# chat with the model (scripts archived to .archive/training_insights/scripts/)

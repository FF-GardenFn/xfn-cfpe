...
from core.gpt import GPT, GPTConfig, Linear
from core.dataloader import tokenizing_distributed_data_loader_bos_bestfit, tokenizing_distributed_data_loader_with_state_bos_bestfit
...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="core", name=args.run, config=user_config)
...
if batch_ratio != 1.0:
    # SGD: linear scaling with batch size is standard (not used in core)

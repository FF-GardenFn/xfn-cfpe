...
Examples:
    ...
    # Evaluate a core model (e.g. d24) using 8 GPUs
...
class ModelWrapper:
    """Lightweight wrapper to give HuggingFace models a core-compatible interface."""
...
def main():
    ...
    parser.add_argument('--model-tag', type=str, default=None, help='core model tag to identify the checkpoint directory')

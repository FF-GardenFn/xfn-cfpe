...
import wandb
import torch
from core.common import compute_init, compute_cleanup, print0, DummyWandb, get_base_dir, autodetect_device_type, get_peak_flops, COMPUTE_DTYPE, COMPUTE_DTYPE_REASON, is_ddp_initialized
from core.tokenizer import get_token_bytes
from core.checkpoint_manager import save_checkpoint, load_model, load_optimizer_state
...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="core-sft", name=args.run, config=user_config)
